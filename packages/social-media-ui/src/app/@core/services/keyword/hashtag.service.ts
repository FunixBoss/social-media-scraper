...
export class HashtagService {
  ...
  findAll(keyword?: string): Observable<ApiResponse<FindAllHashtagDTO[]>> {
    const url: string = `${this.baseUrlService.scraperServerHost}/hashtag`
  ...
  findByKeyword(keyword: string): Observable<ApiResponse<FindAllHashtagDTO[]>> {
    const url: string = `${this.baseUrlService.scraperServerHost}/hashtag/${keyword}`
  ...
  findByHashtag(hashtag: string): Observable<ApiResponse<FindOneChannelDTO>> {
    const url: string = `${this.baseUrlService.scraperServerHost}/hashtag/${hashtag}`
  ...
  deleteHashtags(hashtags: FindAllHashtagDTO[]): Observable<void> {
    const url: string = `${this.baseUrlService.scraperServerHost}/hashtag/delete-hashtags`
